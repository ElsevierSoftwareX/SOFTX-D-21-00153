 ...
 * @author posenato
 */
public class LazyGraphMLWriterTest {

	/**
	 * 
	 */
	String fileName = "src/test/resources/testLazyGraphML.cstnlw";
	...
	@Test
	public void testGraphMLWriterAbstractLayoutOfLabeledNodeLabeledIntEdge() {
		...
		Y.setObservable('p');
		X.setLabel(p);
		LabeledLazyWeightEdge xy = new LabeledLazyWeightEdge("XY");
		xy.mergeLabeledValue(p, new LazyPiece(Fraction.ONE, 1, 6, false));
		LabeledLazyWeightEdge yx = new LabeledLazyWeightEdge("YX");
		yx.mergeLabeledValue(p, new LazyPiece(Fraction.ONE, -1, 6, false));
