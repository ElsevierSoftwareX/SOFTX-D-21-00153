...
public class CSTNUGraphMLReaderTest {
	 ...
	 * logger
	 */
	static final Logger LOG = Logger.getLogger(CSTNUGraphMLReaderTest.class.getName());
	 ...
	 */
	public CSTNUGraphMLReaderTest(final File graphFile, Class<? extends LabeledIntMap> labeledValueSetImplementationClass) throws FileNotFoundException {
		...
		graphReader.getVertexIDs().forEach(new BiConsumer<LabeledNode, String>() {
			...
			public void accept(LabeledNode n, String s) {
				...
				if (s.equals(CSTN.ZeroNodeName))
					CSTNUGraphMLReaderTest.this.graph.setZ(n);
				if (s.equals(CSTN.OmegaNodeName))
					CSTNUGraphMLReaderTest.this.graph.setΩ(n);
			}
		});
		// Label
	...
	public static void main(String[] args) throws IOException, ParserConfigurationException, SAXException {
		File file = new File("/Users/posenato/Dropbox/_CSTNU/007r.cstnu");
		CSTNUGraphMLReaderTest cSTNUGraphMLReaderTest = new CSTNUGraphMLReaderTest(file, LabeledIntTreeMap.class);
		System.out.println("Grafo con CSTNUGraphMLReader: " + cSTNUGraphMLReaderTest.readGraph());
	}
