 ...
 * @author posenato
 */
public class pathT2_T3_T4 {

	/**
	 * Logger della classe.
	 */
	static Logger LOG = Logger.getLogger(pathT2_T3_T4.class.getName());
...
//		final int infty = DistanceGraph.defaultUB;
		...
		g.setEdge(1, 2, "C1T2", 1, 1);
		g.setEdge(3, 4, "T2C2", 1, 1);
		g.setEdge(5, 6, "C2T3", 1, 1);
		g.setEdge(7, 8, "T3C3", 1, 1);
		g.setEdge(9, 10, "C3T5", 1, 1);
		g.setEdge(11, 12, "T5C4", 1, 1);
//		g.setEdge(7, 4, "T5O1", 1, 1);
//		g.setEdge(9, 12, "C2O2", 1, 1);
		

		g.setConstraint(0, 13, "S_C1-E_C4", 15, 34);
//		g.setConstraint(2, 11, "S_T2-E_T4", 17, 27);
