...
public class LabeledIntHierarchyMapTest {
	 ...
	 * 
	 */
	LabeledIntMap actual = new LabeledIntHierarchyMap();
	/**
	 * 
	 */
	LabeledIntMap actual1 = new LabeledIntHierarchyMap();

	/**
	 * 
	 */
	LabeledIntMap expected = new LabeledIntHierarchyMap();
	...
	public final void checkIntSet() {
		...
		Set<Entry<Label>> set = actual.entrySet();
	...
	public final void simplificationWithUnknown() {
		...
		actual.put(ab, 10);
		actual.put(abUp, 10);
		LabeledIntMap expected = AbstractLabeledIntMap.parse("{(ab, 10) }");
		assertEquals("Test about simplification with unknown labeled numbers:\nexpected:" + expected.size() + "\nactual: " + actual.size(), expected, actual);
