...
public class CSTNUTest {
	...
	/**
	 * Test method for
	 * {@link it.univr.di.cstnu.CSTNU#caseLabelRemovalRule(it.univr.di.cstnu.graph.LabeledIntGraph, it.univr.di.cstnu.graph.LabeledIntGraph, CSTNUCheckStatus)}.
	 */
	...
	public final void testCaseLabelRemovalRule() {
		...
		CSTNU cstnu = new CSTNU(true, true);
	...
	/**
	 * Test method for
	 * {@link it.univr.di.cstnu.CSTNU#crossCaseRule(it.univr.di.cstnu.graph.LabeledIntGraph, it.univr.di.cstnu.graph.LabeledIntGraph, CSTNUCheckStatus)}.
	 */
	@SuppressWarnings({ "static-method" })
	@Test
	...
	/**
	 * Test method for {@link it.univr.di.cstnu.CSTNU#labelModificationR1R3R5(LabeledIntGraph, LabeledIntGraph, CSTNUCheckStatus)))}.
	 */
	@SuppressWarnings({ "static-method", "javadoc" })
	@Test
	...
	/**
	 * Test method for {@link it.univr.di.cstnu.CSTNU#lowerCaseRule(LabeledIntGraph, LabeledIntGraph, CSTNUCheckStatus)}.
	 */
	@SuppressWarnings({ "static-method" })
	@Test
	...
	/**
	 * Test method for {@link it.univr.di.cstnu.CSTNU#upperCaseRule(LabeledIntGraph, LabeledIntGraph, CSTNUCheckStatus)}.
	 */
	@SuppressWarnings({ "static-method" })
	@Test
	...
	/**
	 * Test method for {@link it.univr.di.cstnu.CSTNU#noCaseRule(LabeledIntGraph, LabeledIntGraph, CSTNUCheckStatus)}.
	 */
	@SuppressWarnings({ "static-method" })
	@Test
	public final void testNoCase() {
		...
		assertEquals("No case: XY upper case labedled values.", xyOK.getUpperLabelSet(),
				g1.findEdge(g1.getNode("X"), g1.getNode("Y")).getUpperLabelSet());
	}
